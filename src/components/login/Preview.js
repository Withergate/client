                ...
                <Translate>
                    {({ translate }) => 
                        <a href={translate("login.preview.image1")} target="_blank" rel="noopener noreferrer">
                            <Image src={translate("login.preview.image1")} className="w-100 mb-2" />
                        </a>
                    }
                </Translate>
                ...
                <Translate>
                    {({ translate }) => 
                        <a href={translate("login.preview.image2")} target="_blank" rel="noopener noreferrer">
                            <Image src={translate("login.preview.image2")} className="w-100 mb-2" />
                        </a>
                    }
                </Translate>
                ...
                <Translate>
                    {({ translate }) => 
                        <a href={translate("login.preview.image3")} target="_blank" rel="noopener noreferrer">
                            <Image src={translate("login.preview.image3")} className="w-100 mb-2" />
                        </a>
                    }
                </Translate>
                ...
                <Translate>
                    {({ translate }) => 
                        <a href={translate("login.preview.image4")} target="_blank" rel="noopener noreferrer">
                            <Image src={translate("login.preview.image4")} className="w-100 mb-2" />
                        </a>
                    }
                </Translate>
