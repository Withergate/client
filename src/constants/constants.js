...
export const COMBAT_ROLL = 'COMBAT_ROLL';
export const WEAPON_ROLL = 'WEAPON_ROLL';
export const SCAVENGE = 'SCAVENGE';
export const CRAFTSMANSHIP = 'CRAFTSMANSHIP';
export const CRAFTSMANSHIP_LOW = 'CRAFTSMASHIP_LOW';
export const INTELLECT = 'INTELLECT';
export const INTELLECT_LOW = 'INTELLECT_LOW';
